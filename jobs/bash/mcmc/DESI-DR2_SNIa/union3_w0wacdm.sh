...
#SBATCH --output=/scratch/tanveerk/bayesian-model-workspace/slurm-log/20260611/%x-%j.out
...
find "/scratch/tanveerk/bayesian-model-workspace/chains/mcmc/DESI-DR2_SN/${model}/" -name "*.locked" -type f -delete
...
srun python -m cobaya run "/scratch/tanveerk/bayesian-model-workspace/yaml/DESI-DR2_SNIa/${model}.yaml"
