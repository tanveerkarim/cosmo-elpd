...
#SBATCH --job-name=smaller-w0wa-desy5
#SBATCH --nodes=1
...
export COBAYA_PACKAGES_PATH=/scratch/tanveerk/cobaya-external-desy5
...
find /scratch/tanveerk/DESI-DR2_SN-Pantheon+_CMB-CamSpecLensing/w0waCDM-smaller-desy5/ -name "*.locked" -type f -delete
find /scratch/tanveerk/cobaya-external-desy5/data/planck_2018_CamSpec2021/ -name "*.locked" -type f -delete
...
srun python -m cobaya run /scratch/tanveerk/bayesian-model-workspace/DESI-DR2_Pantheon+_CMB-CamSpec-w0wacdm-smaller-DESY5.yaml --resume
