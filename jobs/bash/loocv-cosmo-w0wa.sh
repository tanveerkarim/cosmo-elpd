...
#SBATCH --job-name=smaller-w0wa-pc
#SBATCH --nodes=1
...
find /scratch/tanveerk/DESI-DR2_SN-Pantheon+_CMB-CamSpecLensing/w0waCDM-smaller/ -name "*.locked" -type f -delete
find /scratch/tanveerk/cobaya-external-w0wa/data/planck_2018_CamSpec2021/ -name "*.locked" -type f -delete
...
srun python -m cobaya run /scratch/tanveerk/bayesian-model-workspace/DESI-DR2_Pantheon+_CMB-CamSpec-w0wacdm-smaller.yaml --resume
