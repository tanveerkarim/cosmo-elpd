...
#SBATCH --output=/scratch/tanveerk/bayesian-model-workspace/slurm-log/20260609/%x-%j.out
...
find /scratch/tanveerk/bayesian-model-workspace/chains/nested/desdovekie_lcdm/ -name "*.locked" -type f -delete
...
srun python -m cobaya run /scratch/tanveerk/bayesian-model-workspace/yaml/DESI-DR2_CMB-CamSpec_SNIa/nested/desdovekie_lcdm.yaml --resume
