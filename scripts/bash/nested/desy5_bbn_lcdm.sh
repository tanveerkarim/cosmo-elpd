...
find /scratch/tanveerk/bayesian-model-workspace/chains/nested/desy5_bbn_lcdm/ -name "*.locked" -type f -delete
...
srun python -m cobaya run /scratch/tanveerk/bayesian-model-workspace/yaml/DESI-DR2_CMB-CamSpec_SNIa/nested/desy5_bbn-parthenope880.2_lcdm.yaml
