...
find /scratch/tanveerk/DESI-DR2_SN-Pantheon+_CMB-CamSpecLensing/lcdm-smaller-desy5/ -name "*.locked" -type f -delete
...
srun python -m cobaya run /scratch/tanveerk/bayesian-model-workspace/DESI-DR2_Pantheon+_CMB-CamSpec-lcdm-smaller-DESY5.yaml --resume
